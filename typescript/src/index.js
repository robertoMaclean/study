...
var Personaje = /** @class */ (function () {
    function Personaje(id, name, nivel, hp) {
        this.id = id;
        this.name = name;
        this.nivel = nivel;
        this.hp = hp;
    ...
    Personaje.agregarPersonaje = function () {
        Personaje.equipo++;
    };
    Personaje.prototype.cambiarHP = function (cantidad) {
    ...
    Personaje.prototype.getEquipo = function () {
        return Personaje.equipo;
    };
    Personaje.equipo = 1;
    return Personaje;
}());
var personaje = new Personaje(1, 'Nicolas', 1, 100);
personaje.cambiarHP(-10);
var personaje1 = new Personaje(2, 'Chanchito', 1, 120);
